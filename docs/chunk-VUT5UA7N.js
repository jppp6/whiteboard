import {
    ...
    Tc as ue,
    Rc as x,
} from "../chunk-JXYFKDPR.js";
import { c as ft, a as le } from "../chunk-ODN5LVDJ.js";
function pt(i) {
    return new S(3e3, !1);
}
function jt() {
...
function Ot(i, e, t = new Map(), s = new Map()) {
    let n = [],
        r = [],
        a = -1,
        o = null;
        ...
        (e.forEach((l) => {
            ...
            l.forEach((_, y) => {
                let d = y,
                    g = _;
                if (y !== "offset")
                    switch (((d = i.normalizePropertyName(d, n)), g)) {
                        case ue:
                            g = t.get(y);
                            break;
                        case B:
                            ...
                            break;
                        default:
                            g = i.normalizeStyleValue(y, d, g, n);
                            break;
                    }
                c.set(d, g);
            }),
...
function xe(i, e, t, s) {
    switch (e) {
        case "start":
            i.onStart(() => s(t && Ce(t, "start", i)));
            break;
        case "done":
            i.onDone(() => s(t && Ce(t, "done", i)));
            break;
        case "destroy":
            i.onDestroy(() => s(t && Ce(t, "destroy", i)));
            break;
    }
}
function Ce(i, e, t) {
...
function Ns(i) {
    H ||
        ((H = Ms() || {}), (yt = H.style ? "WebkitAppearance" in H.style : !1));
    let e = !0;
    return (
        H.style &&
            !Ps(i) &&
...
var It = (() => {
        class i {
            ...
            animate(t, s, n, r, a, o = [], l) {
                return new x(n, r);
            }
            static ɵfac = function (s) {
                return new (s || i)();
            };
            static ɵprov = dt({ token: i, factory: i.ɵfac });
        }
        return i;
    })(),
    _t = class {
...
function $(i) {
    ...
    let e = i.match(/^(-?[\.\d]+)(m?s)/);
    return !e || e.length < 2 ? 0 : Ke(parseFloat(e[1]), e[2]);
}
function Ke(i, e) {
    switch (e) {
        case "s":
...
function ye(i, e, t) {
    return i.hasOwnProperty("duration") ? i : Ds(i, e, t);
}
function Ds(i, e, t) {
    let s =
    ...
    if (typeof i == "string") {
        let o = i.match(s);
        if (o === null)
            return e.push(pt(i)), { duration: 0, delay: 0, easing: "" };
        n = Ke(parseFloat(o[1]), o[2]);
        let l = o[3];
        l != null && (r = Ke(parseFloat(l), o[4]));
        let u = o[5];
        u && (a = u);
    } else n = i;
    if (!t) {
    ...
    return { duration: n, delay: r, easing: a };
}
function Rs(i) {
    return i.length
        ? i[0] instanceof Map
            ? i
            : i.map((e) => new Map(Object.entries(e)))
        : [];
}
function Et(i) {
    return Array.isArray(i) ? new Map(...i) : new Map(i);
}
function Q(i, e, t) {
    e.forEach((s, n) => {
        let r = nt(n);
        t && !t.has(n) && t.set(n, i.style[r]), (i.style[r] = s);
    });
}
function X(i, e) {
    e.forEach((t, s) => {
...
function se(i) {
    return Array.isArray(i) ? (i.length == 1 ? i[0] : mt(i)) : i;
}
function Os(i, e, t) {
    let s = e.params || {},
        n = Kt(i);
    n.length &&
        n.forEach((r) => {
            s.hasOwnProperty(r) || t.push(Gt(r));
        });
}
var qe = new RegExp(`${zt}\\s*(.+?)\\s*${ks}`, "g");
function Kt(i) {
    let e = [];
    if (typeof i == "string") {
        let t;
        for (; (t = qe.exec(i)); ) e.push(t[1]);
        qe.lastIndex = 0;
    }
    return e;
}
function ie(i, e, t) {
    let s = `${i}`,
        n = s.replace(qe, (r, a) => {
            let o = e[a];
            return o == null && (t.push(Ht(a)), (o = "")), o.toString();
        });
    return n == s ? i : n;
}
var Ls = /-+([a-z0-9])/g;
function nt(i) {
    return i.replace(Ls, (...e) => e[1].toUpperCase());
}
function An(i) {
...
function Is(i, e, t) {
    if (t.size && e.length) {
        ...
        if (
            (t.forEach((r, a) => {
                s.has(a) || n.push(a), s.set(a, r);
            }),
            n.length)
        )
            for (let r = 1; r < e.length; r++) {
                let a = e[r];
                n.forEach((o) => a.set(o, it(i, o)));
            }
    }
    return e;
}
...
function Ks(i, e) {
    ...
    return (
        typeof i == "string"
            ? i.split(/\s*,\s*/).forEach((s) => qs(s, t, e))
            : t.push(i),
        t
    );
}
function qs(i, e, t) {
    ...
    let s = i.match(/^(\*|[-\w]+)\s*(<?[=-]>)\s*(\*|[-\w]+)$/);
    if (s == null || s.length < 4) return t.push(ls(i)), e;
    let n = s[1],
        r = s[2],
        a = s[3];
    e.push(Tt(n, a));
...
var he = new Set(["true", "1"]),
    fe = new Set(["false", "0"]);
function Tt(i, e) {
    let t = he.has(i) || fe.has(i),
        s = he.has(e) || fe.has(e);
    return (n, r) => {
        let a = i == _e || i == n,
            o = e == _e || e == r;
        return (
            !a && t && typeof n == "boolean" && (a = n ? he.has(i) : fe.has(i)),
            !o && s && typeof r == "boolean" && (o = r ? he.has(e) : fe.has(e)),
            a && o
        );
    };
}
var qt = ":self",
    Qs = new RegExp(`s*${qt}s*,?`, "g");
function rt(i, e, t, s) {
    return new Qe(i).build(e, t, s);
}
var vt = "",
    Qe = class {
        _driver;
        ...
        build(e, t, s) {
            let n = new $e(t);
            return this._resetContextStyleTimingState(n), O(this, se(e), n);
        }
        _resetContextStyleTimingState(e) {
            (e.currentQuerySelector = vt),
                (e.collectedStyles = new Map()),
                e.collectedStyles.set(vt, new Map()),
                (e.currentTime = 0);
        }
        visitTrigger(e, t) {
            ...
            return (
                ...
                e.definitions.forEach((o) => {
                    if (
                        ...
                        (s += l.queryCount), (n += l.depCount), a.push(l);
        ...
        visitState(e, t) {
            ...
            if (s.containsDynamicStyles) {
                ...
                s.styles.forEach((o) => {
                    ...
                    r.size && t.errors.push(xt(e.name, [...r.values()]));
            }
            return {
                type: E.State,
                name: e.name,
        ...
        visitTransition(e, t) {
            ...
            let s = O(this, se(e.animation), t),
                n = Ks(e.expr, t.errors);
            return {
                type: E.Transition,
                matchers: n,
                animation: s,
        ...
        visitGroup(e, t) {
            ...
            return (
                (t.currentTime = n),
                { type: E.Group, steps: r, options: Y(e.options) }
            );
        }
        visitAnimate(e, t) {
            let s = js(e.timings, t.errors);
            t.currentAnimateTimings = s;
            let n,
                r = e.styles ? e.styles : Ne({});
            if (r.type == E.Keyframes) n = this.visitKeyframes(r, t);
            else {
                let a = e.styles,
                    o = !1;
                if (!a) {
                    o = !0;
                    let u = {};
                    s.easing && (u.easing = s.easing), (a = Ne(u));
                }
            ...
            return (
                ...
                { type: E.Animate, timings: s, style: n, options: null }
            );
        }
        visitStyle(e, t) {
                        ...
                        a.forEach((o, l) => {
                            ...
                            h &&
                                (r != n &&
                                    ...
                                    n <= h.endTime &&
                                    (t.errors.push(
                                        ts(l, h.startTime, h.endTime, r, n)
                                    ),
                                    (c = !1)),
                                (r = h.startTime)),
                                c && u.set(l, { startTime: r, endTime: n }),
                                t.options && Os(o, t.options, t.errors);
                        });
                });
        }
        visitKeyframes(e, t) {
            let s = { type: E.Keyframes, styles: [], options: null };
            if (!t.currentAnimateTimings) return t.errors.push(ss()), s;
            let n = 1,
                r = 0,
                a = [],
                o = !1,
                ...
                h = e.steps.map((b) => {
                    let A = this._makeStyleAst(b, t),
                        C = A.offset != null ? A.offset : Us(A.styles),
                        N = 0;
                    return (
            ...
            l && t.errors.push(ns()), o && t.errors.push(is());
            let c = e.steps.length,
                _ = 0;
            r > 0 && r < c ? t.errors.push(rs()) : r == 0 && (_ = n / (c - 1));
            let y = c - 1,
                d = t.currentTime,
        ...
        visitReference(e, t) {
            return {
                type: E.Reference,
                animation: O(this, se(e.animation), t),
                options: Y(e.options),
            };
        }
        visitAnimateChild(e, t) {
            return (
                t.depCount++, { type: E.AnimateChild, options: Y(e.options) }
            );
        }
        visitAnimateRef(e, t) {
            return {
...
function $s(i) {
    let e = !!i.split(/\s*,\s*/).find((t) => t == qt);
    return (
        e && (i = i.replace(Qs, "")),
        (i = i
            .replace(/@\*/g, ge)
            .replace(/@\w+/g, (t) => ge + "-" + t.slice(1))
...
function js(i, e) {
    ...
    let n = ye(t, e);
    return ke(n.duration, n.delay, n.easing);
}
function Y(i) {
    return (
        i ? ((i = le({}, i)), i.params && (i.params = Vs(i.params))) : (i = {}),
        i
    );
}
function ke(i, e, t) {
...
function at(i, e, t, s, n, r, a = null, o = !1) {
    return {
        type: 1,
        element: i,
        keyframes: e,
...
var te = class {
    ...
    Ys = ":leave",
    Xs = new RegExp(Ys, "g");
function ot(i, e, t, s, n, r = new Map(), a = new Map(), o, l, u = []) {
    return new Ve().buildKeyframes(i, e, t, s, n, r, a, o, l, u);
}
var Ve = class {
        buildKeyframes(e, t, s, n, r, a, o, l, u, h = []) {
            u = u || new te();
            let c = new Ue(e, t, u, n, r, h, []);
            c.options = l;
            let _ = l.delay ? $(l.delay) : 0;
            c.currentTimeline.delayNextStep(_),
                c.currentTimeline.setStyles([a], null, c.errors, l),
                O(this, s, c);
        ...
        visitAnimateChild(e, t) {
            ...
            if (s) {
                let n = t.createSubContext(e.options),
                    ...
                    a = this._visitSubInstructions(s, n, n.options);
        ...
        _visitSubInstructions(e, t, s) {
            ...
            return (
                a !== 0 &&
                    e.forEach((l) => {
                        let u = t.appendInstructionToTimeline(l, a, o);
        ...
        visitSequence(e, t) {
            ...
            if (
                r &&
                (r.params || r.delay) &&
                ((n = t.createSubContext(r)),
                n.transformIntoNewTimeline(),
                r.delay != null)
            ) {
                n.previousNode.type == E.Style &&
            ...
            e.steps.length &&
                (e.steps.forEach((a) => O(this, a, n)),
                n.currentTimeline.applyStylesToKeyframe(),
                n.subContextCount > s && n.transformIntoNewTimeline()),
                (t.previousNode = e);
        }
        visitGroup(e, t) {
            let s = [],
        ...
        _visitTiming(e, t) {
            if (e.dynamic) {
                let s = e.strValue,
                    n = t.params ? ie(s, t.params, t.errors) : s;
                return ye(n, t.errors);
            } else
                return {
                    duration: e.duration,
                    delay: e.delay,
        ...
        visitAnimate(e, t) {
            let s = (t.currentAnimateTimings = this._visitTiming(e.timings, t)),
                n = t.currentTimeline;
            s.delay && (t.incrementTime(s.delay), n.snapshotCurrentStyles());
            let r = e.style;
            r.type == E.Keyframes
        ...
        visitStyle(e, t) {
            ...
            !n && s.hasCurrentStyleProperties() && s.forwardFrame();
        ...
        visitQuery(e, t) {
            ...
            o.forEach((u, h) => {
                ...
                r && c.delayNextStep(r),
                    ...
                    O(this, e.animation, c),
                    c.currentTimeline.applyStylesToKeyframe();
                let _ = c.currentTimeline.currentTime;
                a = Math.max(a, _);
            }),
        ...
        visitStagger(e, t) {
            ...
            O(this, e.animation, t),
                ...
                (s.currentStaggerTime =
                    n.currentTime -
                    c +
                    (n.startTime - s.currentTimeline.startTime));
        }
    },
    Se = {},
    Ue = class i {
        ...
        constructor(e, t, s, n, r, a, o, l) {
            (this._driver = e),
                ...
                (this.errors = a),
                (this.timelines = o),
                (this.currentTimeline = l || new Ee(this._driver, t, 0)),
        ...
        updateOptions(e, t) {
            ...
            let s = e,
                n = this.options;
            s.duration != null && (n.duration = $(s.duration)),
                s.delay != null && (n.delay = $(s.delay));
            let r = s.params;
            if (r) {
                let a = n.params;
        ...
        createSubContext(e = null, t, s) {
            let n = t || this.element,
                r = new i(
                    ...
                    this.errors,
                    this.timelines,
                    this.currentTimeline.fork(n, s || 0)
                );
            return (
        ...
        invokeQuery(e, t, s, n, r, a) {
            let o = [];
            if ((n && o.push(this.element), e.length > 0)) {
                (e = e.replace(Hs, "." + this._enterClassName)),
                ...
                s !== 0 &&
                    (u =
                        s < 0
                            ? u.slice(u.length + s, u.length)
                            : u.slice(0, s)),
                    o.push(...u);
            }
            return !r && o.length == 0 && a.push(os(t)), o;
        }
    },
    Ee = class i {
        _driver;
        ...
        forwardFrame() {
            (this.duration += Ws), this._loadKeyframe();
        }
        forwardTime(e) {
            this.applyStylesToKeyframe(),
                (this.duration = e),
        ...
        setStyles(e, t, s, n) {
            ...
            let r = (n && n.params) || {},
                a = Zs(e, this._globalTimelineStyles);
            for (let [o, l] of a) {
                let u = ie(l, r, s);
                this._pendingStyles.set(o, u),
                    this._localTimelineStyles.has(o) ||
                        this._backFill.set(
                            o,
                            this._globalTimelineStyles.get(o) ?? B
                        ),
                    this._updateStyle(o, u);
            }
        }
        ...
        mergeTimelineCollectedStyles(e) {
            e._styleSummary.forEach((t, s) => {
                let n = this._styleSummary.get(s);
                (!n || t.time > n.time) && this._updateStyle(s, t.value);
            });
        }
        buildKeyframes() {
            this.applyStylesToKeyframe();
            ...
            this._keyframes.forEach((o, l) => {
                let u = new Map([...this._backFill, ...o]);
                u.forEach((h, c) => {
                    h === ue ? e.add(c) : h === B && t.add(c);
                }),
    ...
    je = class extends Ee {
        ...
        buildKeyframes() {
            let e = this.keyframes,
                { delay: t, duration: s, easing: n } = this.timings;
            if (this._stretchStartingKeyframe && t) {
                ...
                let u = new Map(e[0]);
                u.set("offset", wt(o)), r.push(u);
                let h = e.length - 1;
                for (let c = 1; c <= h; c++) {
                    let _ = new Map(e[c]),
                        y = _.get("offset"),
                        d = t + y * s;
                    _.set("offset", wt(d / a)), r.push(_);
                }
                (s = a), (t = 0), (n = ""), (e = r);
            }
            return at(
...
function Zs(i, e) {
    ...
    return (
        i.forEach((n) => {
            ...
            } else for (let [r, a] of n) t.set(r, a);
        }),
        t
    );
}
function bt(i, e, t, s, n, r, a, o, l, u, h, c, _) {
    return {
        type: 0,
        element: i,
        triggerName: e,
...
var De = {},
    Te = class {
        ...
        match(e, t, s, n) {
            return Js(this.ast.matchers, e, t, s, n);
        }
        buildStyles(e, t, s) {
            let n = this._stateStyles.get("*");
            return (
                e !== void 0 && (n = this._stateStyles.get(e?.toString()) || n),
                n ? n.buildStyles(t, s) : new Map()
            );
        }
        build(e, t, s, n, r, a, o, l, u, h) {
            let c = [],
                _ = (this.ast.options && this.ast.options.params) || De,
                y = (o && o.params) || De,
                d = this.buildStyles(s, y, c),
                g = (l && l.params) || De,
                v = this.buildStyles(n, g, c),
                b = new Set(),
                A = new Map(),
                C = new Map(),
                N = n === "void",
                Z = { params: Bt(g, _), delay: this.ast.options?.delay },
                K = h ? [] : ot(e, t, this.ast.animation, r, a, d, v, Z, u, c),
                k = 0;
            return (
                K.forEach((D) => {
                ...
                c.length
                    ...
                    : (K.forEach((D) => {
                          ...
                          let lt = L(C, j, new Set());
                          D.postStyleProps.forEach((W) => lt.add(W)),
                              j !== t && b.add(j);
                      }),
                      bt(
                          t,
...
function Js(i, e, t, s, n) {
    return i.some((r) => r(e, t, s, n));
}
function Bt(i, e) {
    let t = le({}, e);
    return (
    ...
    constructor(e, t, s) {
        (this.name = e),
            ...
            t.states.forEach((n) => {
                ...
                this.states.set(n.name, new We(n.style, r, s));
            }),
            At(this.states, "true", "1"),
            At(this.states, "false", "0"),
            t.transitions.forEach((n) => {
                this.transitionFactories.push(new Te(e, n, this.states));
            }),
            (this.fallbackTransition = en(e, this.states, this._normalizer));
    }
    get containsQueries() {
        return this.ast.queryCount > 0;
    }
    matchTransition(e, t, s, n) {
        return (
            this.transitionFactories.find((a) => a.match(e, t, s, n)) || null
        );
    }
    matchStyles(e, t, s) {
...
function en(i, e, t) {
    let s = [(a, o) => !0],
        n = { type: E.Sequence, steps: [], options: null },
        r = {
            type: E.Transition,
            animation: n,
            matchers: s,
...
var tn = new te(),
    He = class {
        ...
        register(e, t) {
            let s = [],
                n = [],
                r = rt(this._driver, t, s, n);
            if (s.length) throw ms(s);
        ...
        create(e, t, s = {}) {
            ...
            if (
                (r
                    ? ((a = ot(
                      ...
                      a.forEach((h) => {
                          let c = L(o, h.element, new Map());
                          h.postStyleProps.forEach((_) => c.set(_, null));
                      }))
                    : (n.push(ps()), (a = [])),
                n.length)
            )
            ...
            o.forEach((h, c) => {
                h.forEach((_, y) => {
                    h.set(y, this._driver.computeStyle(c, y, B));
                });
            });
            let l = a.map((h) => {
                    let c = o.get(h.element);
        ...
        listen(e, t, s, n) {
            let r = et(t, "", "", "");
            return xe(this._getPlayer(e), s, r, n), () => {};
        }
        command(e, t, s, n) {
            if (s == "register") {
                this.register(e, n[0]);
    ...
    Pt = "ng-animate-queued",
    sn = ".ng-animate-queued",
    ...
    Ye = class {
        ...
        listen(e, t, s, n) {
            if (!this._triggers.has(t)) throw _s(s, t);
            if (s == null || s.length == 0) throw Ss(t);
            if (!hn(s)) throw Es(s, t);
            let r = L(this._elementListeners, e, []),
                a = { name: t, phase: s, callback: n };
            r.push(a);
            let o = L(this._engine.statesByElement, e, new Map());
            return (
                o.has(t) || (I(e, ce), I(e, ce + "-" + t), o.set(t, Oe)),
                () => {
        ...
        trigger(e, t, s, n = !0) {
            ...
            if (
                ...
                o.set(t, u),
                l || (l = Oe),
                !(u.value === ne) && l.value === u.value)
            ) {
                if (!mn(l.params, u.params)) {
                    let g = [],
                        v = r.matchStyles(l.value, l.params, g),
                        b = r.matchStyles(u.value, u.params, g);
                    g.length
        ...
        _signalRemovalForInnerTriggers(e, t) {
            let s = this._engine.driver.query(e, ge, !0);
            s.forEach((n) => {
                if (n[z]) return;
                let r = this._engine.fetchNamespacesByElement(n);
                r.size
                    ? r.forEach((a) => a.triggerLeaveAnimation(n, t, !1, !0))
                    : this.clearElementCache(n);
            }),
                this._engine.afterFlushAnimationsDone(() =>
                    s.forEach((n) => this.clearElementCache(n))
                );
        }
        triggerLeaveAnimation(e, t, s, n) {
                    ...
                    a &&
                        a.forEach((o) => {
                            if (o.name == s.triggerName) {
                                ...
                                (l._data = e),
                                    xe(s.player, o.phase, l, o.callback);
                            }
                        }),
                        n.markedForDestroy
                            ? this._engine.afterFlush(() => {
    ...
    Xe = class {
        ...
        registerTrigger(e, t, s) {
            ...
            n && n.register(t, s) && this.totalAnimations++;
        }
        destroy(e, t) {
            e &&
                (this.afterFlush(() => {}),
                this.afterFlushAnimationsDone(() => {
                    ...
                    let n = this._namespaceList.indexOf(s);
        ...
        listen(e, t, s, n, r) {
            return de(t)
                ? this._fetchNamespace(e).listen(t, s, n, r)
                : () => {};
        }
        _buildInstruction(e, t, s, n, r) {
        ...
        destroyInnerAnimations(e) {
            let t = this.driver.query(e, ge, !0);
        ...
        processLeaveNode(e) {
            ...
            e.classList?.contains(Re) && this.markElementAsDisabled(e, !1),
                this.driver.query(e, nn, !0).forEach((s) => {
        ...
        flush(e = -1) {
            ...
            if (
                (this.newHostElements.size &&
                    (this.newHostElements.forEach((s, n) =>
                        this._balanceNamespaceList(s, n)
                    ),
                    this.newHostElements.clear()),
                this.totalAnimations && this.collectedEnterElements.length)
            )
                for (let s = 0; s < this.collectedEnterElements.length; s++) {
                    let n = this.collectedEnterElements[s];
                    I(n, rn);
                }
            if (
                ...
                try {
                    ...
                    for (let n = 0; n < s.length; n++) s[n]();
                }
            } else
                for (let s = 0; s < this.collectedLeaveElements.length; s++) {
                    let n = this.collectedLeaveElements[s];
        ...
        _flushAnimations(e, t) {
            ...
            for (let f = 0; f < this.collectedLeaveElements.length; f++) {
                ...
                p &&
                    ...
                    b.add(m),
                    p.hasAnimation
                        ? this.driver.query(m, an, !0).forEach((T) => b.add(T))
                        : A.add(m));
            }
            let C = new Map(),
                N = Ct(_, Array.from(b));
                    ...
                    .forEach((p) => {
                            ...
                            if (M && M.setForMove) {
                                if (
                                    ...
                                    if (F && F.has(p.triggerName)) {
                                        let oe = F.get(p.triggerName);
                                        (oe.value = G),
                                            F.set(p.triggerName, oe);
                                    }
                                }
                                T.destroy();
                                return;
                        ...
                        w.timelines.forEach((M) => {
                            (M.stretchStartingKeyframe = !0),
                                this.disabledNodes.has(M.element) || ht.push(M);
                        }),
                            (w.timelines = ht),
                            s.append(P, w.timelines);
                        let Ut = { instruction: w, player: T, element: P };
                        a.push(Ut),
            ...
            if (K.length) {
                let f = [];
                K.forEach((m) => {
                    f.push(ws(m.triggerName, m.errors));
                }),
            ...
            let j = v.filter((f) => kt(f, l, u)),
                J = new Map();
            Mt(J, this.driver, A, u, B).forEach((f) => {
                kt(f, l, u) && j.push(f);
            });
            let W = new Map();
            y.forEach((f, m) => {
                Mt(W, this.driver, new Set(f), l, ue);
            }),
                j.forEach((f) => {
                    let m = J.get(f),
                        p = W.get(f);
            ...
            a.forEach((f) => {
                ...
                if (s.has(m)) {
                    ...
                    if ((p.setRealPlayer(q), P === ct)) Ae.push(p);
                    else {
                        let R = this.playersByElement.get(P);
                        R && R.length && (p.parentPlayer = U(R)), n.push(p);
                    }
                } else
                    X(m, T.fromStyles),
                        p.onDestroy(() => Q(m, T.toStyles)),
            ...
            for (let f = 0; f < v.length; f++) {
                let m = v[f],
                    p = m[z];
                if ((ee(m, pe), p && p.hasAnimation)) continue;
                let T = [];
                if (o.size) {
                    let q = o.get(m);
                    q && q.length && T.push(...q);
                    let R = this.driver.query(m, ze, !0);
                ...
                P.length ? fn(this, m, P) : this.processLeaveNode(m);
            }
            return (
                (v.length = 0),
                Ae.forEach((f) => {
        ...
        _getPreviousPlayers(e, t, s, n, r) {
            ...
            if (t) {
                ...
                if (o) {
                    let l = !r || r == ne;
                    o.forEach((u) => {
                        u.queued || (!l && u.triggerName != n) || a.push(u);
                    });
                }
            }
            return (
        ...
        _beforeAnimationBuild(e, t, s) {
            ...
            for (let l of t.timelines) {
                let u = l.element,
                    h = u !== r,
                    c = L(s, u, []);
                this._getPreviousPlayers(u, h, a, o, t.toState).forEach((y) => {
        ...
        _buildAnimation(e, t, s, n, r, a) {
            let o = t.triggerName,
                ...
                _ = t.timelines.map((d) => {
                    ...
                    let b = g !== l,
                        A = dn(
                            (s.get(g) || on).map((k) => k.getRealPlayer())
                        ).filter((k) => {
                            let D = k;
                        ...
                        C = r.get(g),
                        N = a.get(g),
                        Z = Ot(this._normalizer, d.keyframes, C, N),
                        K = this._buildPlayer(d, Z, A);
                    if ((d.subTimeline && n && c.add(g), b)) {
                        let k = new ae(e, o, g);
                        k.setRealPlayer(K), u.push(k);
                    }
                    return K;
                });
            u.forEach((d) => {
                L(this.playersByQueriedElement, d.element, []).push(d),
                    d.onDone(() =>
                        un(this.playersByQueriedElement, d.element, d)
                    );
            }),
                h.forEach((d) => I(d, St));
            let y = U(_);
            return (
                y.onDestroy(() => {
                    h.forEach((d) => ee(d, St)), Q(l, t.toStyles);
                }),
                c.forEach((d) => {
                    L(n, d, []).push(y);
                }),
...
function Mt(i, e, t, s, n) {
    ...
    s.forEach((l, u) => {
        let h = new Map();
        l.forEach((c) => {
            let _ = e.computeStyle(u, c, n);
            h.set(c, _), (!_ || _.length == 0) && ((u[z] = ln), a.push(u));
        }),
            i.set(u, h);
    });
    let o = 0;
    return t.forEach((l) => Nt(l, r[o++])), a;
}
function Ct(i, e) {
    let t = new Map();
    if ((i.forEach((o) => t.set(o, [])), e.length == 0)) return t;
    let s = 1,
        n = new Set(e),
        r = new Map();
    function a(o) {
        ...
        let u = o.parentNode;
        return (
            t.has(u) ? (l = u) : n.has(u) ? (l = s) : (l = a(u)), r.set(o, l), l
        );
    }
    return (
        e.forEach((o) => {
...
function fn(i, e, t) {
    U(t).onDone(() => i.processLeaveNode(e));
}
function dn(i) {
    let e = [];
    return $t(i, e), e;
...
function $t(i, e) {
    for (let t = 0; t < i.length; t++) {
        let s = i[t];
        s instanceof Me ? $t(s.players, e) : e.push(s);
    }
}
function mn(i, e) {
    let t = Object.keys(i),
...
function kt(i, e, t) {
    ...
    if (!s) return !1;
    let n = e.get(i);
    return n ? s.forEach((r) => n.add(r)) : e.set(i, s), t.delete(i), !0;
}
var ve = class {
    _driver;
    _normalizer;
    ...
    constructor(e, t, s) {
        (this._driver = t),
            ...
            (this._transitionEngine.onRemovalComplete = (n, r) =>
                this.onRemovalComplete(n, r));
    }
    registerTrigger(e, t, s, n, r) {
        let a = e + "-" + n,
            o = this._triggerCache[a];
        if (!o) {
            let l = [],
                u = [],
                h = rt(this._driver, r, l, u);
            if (l.length) throw fs(n, l);
            u.length && void 0,
                (o = xs(n, h, this._normalizer)),
    ...
    onInsert(e, t, s, n) {
        this._transitionEngine.insertNode(e, t, s, n);
    }
    onRemove(e, t, s) {
    ...
    process(e, t, s, n) {
        ...
        } else this._transitionEngine.trigger(e, t, s, n);
    }
    listen(e, t, s, n, r) {
        if (s.charAt(0) == "@") {
            let [a, o] = gt(s);
        ...
        return this._transitionEngine.listen(e, t, s, n, r);
    }
    flush(e = -1) {
...
var gn = (() => {
    class i {
        ...
        _initialStyles;
        constructor(t, s, n) {
            (this._element = t), (this._startStyles = s), (this._endStyles = n);
...
var we = class {
        ...
        beforeDestroy() {
            let e = new Map();
            this.hasStarted() &&
                this._finalKeyframe.forEach((s, n) => {
                    n !== "offset" &&
                        e.set(n, this._finished ? s : it(this.element, n));
                }),
    ...
    Ze = class {
        ...
        animate(e, t, s, n, r, a = []) {
            let o = n == 0 ? "both" : "forwards",
                l = { duration: s, delay: n, fill: o };
            r && (l.easing = r);
            let u = new Map(),
                h = a.filter((y) => y instanceof we);
            Fs(s, n) &&
                h.forEach((y) => {
                    y.currentSnapshot.forEach((d, g) => u.set(g, d));
                });
            let c = Rs(t).map((y) => new Map(y));
            c = Is(e, c, u);
            let _ = pn(e, c);
            return new we(e, c, l, _);
        }
    };
function Pn(i, e) {
    return i === "noop"
        ? new ve(e, new It(), new Ie())
        : new ve(e, new Ze(), new Be());
}
var Dt = class {
        _driver;
        _animationAst;
        constructor(e, t) {
            ...
            n.length && void 0, (this._animationAst = r);
        }
        buildTimelines(e, t, s, n, r) {
            let a = Array.isArray(t) ? Et(t) : t,
                o = Array.isArray(s) ? Et(s) : s,
                l = [];
            r = r || new te();
            let u = ot(
                this._driver,
    ...
    be = class {
        ...
        setAttribute(e, t, s, n) {
            this.delegate.setAttribute(e, t, s, n);
        }
        ...
        setStyle(e, t, s, n) {
            this.delegate.setStyle(e, t, s, n);
        }
        removeStyle(e, t, s) {
    ...
    Je = class extends be {
        ...
        constructor(e, t, s, n, r) {
            super(t, s, n, r), (this.factory = e), (this.namespaceId = t);
        }
        setProperty(e, t, s) {
            t.charAt(0) == me
                ? t.charAt(1) == "." && t == Vt
        ...
        listen(e, t, s) {
            if (t.charAt(0) == me) {
                let n = _n(e),
                    ...
                    a = "";
                return (
                    r.charAt(0) != me && ([r, a] = Sn(r)),
                    this.engine.listen(this.namespaceId, n, r, a, (o) => {
                        let l = o._data || -1;
...
var Rt = class {
    ...
    createRenderer(e, t) {
        ...
        if (!e || !t?.data?.animation) {
            ...
            if (!h) {
                let c = () => u.delete(n);
                (h = new be(s, n, this.engine, c)), u.set(n, h);
            }
            return h;
        }
        let r = t.id,
        ...
        let o = (u) => {
            Array.isArray(u)
                ? u.forEach(o)
                : this.engine.registerTrigger(r, a, e, u.name, u);
        };
        return t.data.animation.forEach(o), new Je(this, a, n, this.engine);
    }
    begin() {
...
export {
    _t as AnimationDriver,
    It as NoopAnimationDriver,
    Fs as ɵallowPreviousPlayerStylesMerge,
    Dt as ɵAnimation,
    ve as ɵAnimationEngine,
    Je as ɵAnimationRenderer,
    Rt as ɵAnimationRendererFactory,
    Fe as ɵAnimationStyleNormalizer,
    be as ɵBaseAnimationRenderer,
    An as ɵcamelCaseToDashCase,
    Lt as ɵcontainsElement,
    Pn as ɵcreateEngine,
    tt as ɵgetParentElement,
    Ft as ɵinvokeQuery,
    Ie as ɵNoopAnimationStyleNormalizer,
    Rs as ɵnormalizeKeyframes,
    Ns as ɵvalidateStyleProperty,
    bn as ɵvalidateWebAnimatableStyleProperty,
    Ze as ɵWebAnimationsDriver,
    we as ɵWebAnimationsPlayer,
